...
exports.getRestaurants = exports.createRestaurant = void 0;
...
const createRestaurant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const restaurant = new retaurant_1.default(req.body);
...
const getRestaurants = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const restaurants = yield retaurant_1.default.find();
